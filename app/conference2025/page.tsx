    ...
    <>
      ...
      <div className="flex flex-col items-center mt-16 px-4">
        ...
        <p className="mt-6 text-lg md:text-xl text-gray-700 max-w-[600px] text-center">
          ...
          collaboration, and growth in our UX community. Together, we’ll chart
          new territories and navigate the next chapters of design!
        </p>
      ...
      <div className="flex flex-col items-center w-full mx-auto my-12 px-6 md:px-12 bg-[#3a5e9e] py-8 md:py-16">
        <div className="w-full max-w-[800px] bg-blue-100 rounded-lg p-8 shadow-lg min-h-[300px] flex flex-col justify-between">
